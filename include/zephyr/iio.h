...
// #include <zephyr/iio_types.h>
// #include <stddef.h>
// #include <stdint.h>
// #include <stdbool.h>

// /* If needed, define ssize_t and s64 for Zephyr */
// #ifndef ssize_t
...
// /* Forward declare or stub Linux-specific structs */
// struct device; /* Zephyr device struct is different, adapt as needed */
// struct module; /* Not used in Zephyr, stub for compatibility */
// struct attribute_group; /* Not used in Zephyr, stub for compatibility */
// struct dentry; /* Not used in Zephyr, stub for compatibility */
...
// 	int (*read_raw1)(const struct device *dev,
// 		int *val,
// 		long mask);
...
// 	//__release(indio_dev); - compiler_types.h
// }
...
// {
// 	//if (indio_dev)
// 		//put_device(&indio_dev->dev); - core.c
// }
...
iio_block_foreach_sample(const struct iio_block *block,
			 const struct iio_channels_mask *mask,
			 size_t (*callback)(const struct iio_channel *chn,
